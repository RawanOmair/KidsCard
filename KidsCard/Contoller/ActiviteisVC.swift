...
class ActiviteisVC: UIViewController, UICollectionViewDelegate{
    
    @IBOutlet weak var CardCollectionView: UICollectionView!
    @IBOutlet weak var sentenceCollectionView: UICollectionView!
    
    var CardsArray = [
        Card(name: "Play", image: "play"),
        Card(name: "Dance", image: "Dance"),
        Card(name: "Farm", image: "Farming"),
    ]
...
extension ActiviteisVC : UICollectionViewDataSource
{
...
extension ActiviteisVC : UICollectionViewDragDelegate
{
...
extension ActiviteisVC : UICollectionViewDropDelegate
{
