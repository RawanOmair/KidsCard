...
//  collectionViewCards
//
//  Created by Rahaf Alhubeis on 01/08/1443 AH.
//

import UIKit

class VerbViewController: UIViewController, UICollectionViewDelegate {  
...
//
    ...
    var CardsArray = [
        Card(name: "Want", image: "Want"),
        Card(name: "Feel", image: "Feel"),
    ]
...
extension VerbViewController : UICollectionViewDataSource
{
...
extension VerbViewController : UICollectionViewDragDelegate
{
...
extension VerbViewController : UICollectionViewDropDelegate
{
